'''
 Taken from https://github.com/rtmdrr/testSignificanceNLP/blob/master/testSignificance.py
 with two fixes in the Bootstrap and Permutation tests
 Run with python 2.7
'''
...
def rand_permutation(data_A, data_B, n, R):
    ...
    for x in tqdm(range(0, R)):
        ...
        # if(delta<=delta_orig): #incorrect implementation
        if (delta >= delta_orig):
            r = r+1
